...
The state SAIDI target produces similar results, but fewer rows (one per state). They don't exactly line up with the EIA chart, but states' relative performances are close enough to justify further investigation.
